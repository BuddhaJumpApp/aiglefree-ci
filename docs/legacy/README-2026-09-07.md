...
Build workflows for the **aiglefree** Flutter VPN app. Same pipeline as BuddhaJump's,
...
Checkout:
- `PRIVATE_REPO` — `BuddhaJumpApp/aiglefree`
...
- `APPLE_PROVISIONING_BASE64` — provisioning profiles for `com.fjolsky.aiglefree` and `com.fjolsky.aiglefree.service`
